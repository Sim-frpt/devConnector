...
router.put('/experience', [auth, [
  ...
  async (req, res) => {
    ...
    try {
      ...
      const existingExperience = await Profile.findOne({ })
...
router.get('/github/:username', (req, res) => {
  try{
    const options = {
      uri: `https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${config.get('gitHubClientID')}&secret=${config.get('gitHubClientSecret')}`,
      method: 'GET',
